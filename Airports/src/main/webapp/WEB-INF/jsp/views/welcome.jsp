...
<div class="row">
			...
			<article class="col-sm-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Welcome to International Airports Portal</h1>
				</header>
			...
			<aside class="col-sm-4 sidebar sidebar-right">
				...
				<div class="widget">
					...
					<ul class="list-unstyled list-spaces">
						<li><a href="">About the company</a><br><span class="small text-muted">Here you can find more details about our Structures, company profile and history awards.</span></li>
						<li><a href="">Executive Management</a><br><span class="small text-muted">More information about airport management, board of directors and executive committee.</span></li>
						<li><a href="">Making a difference</a><br><span class="small text-muted">Socio-Economic Development and the environment</span></li>
						<li><a href="">Airline Services</a><br><span class="small text-muted">Assisted passenger information, new airline request and slot request.</span></li>
						<li><a href="">Help us</a><br><span class="small text-muted">If you feel that we can improve on any of our services or if you would like to compliment any of the staff working within our company, please contact us.</span></li>
					</ul>
				</div>
